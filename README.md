...
- [English version of the complete prompt](docs/research-skill-prompt-en.md)
...
3. `docs/research-skill-prompt-en.md`  
   Dùng khi bạn cần một bản tiếng Anh tương đương về mặt logic và độ chặt để dùng với AI hoặc agent platform ưu tiên English prompt.

4. `docs/research-progress-template.md`  
